    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            ...
            <template v-else>
                ...
                <Link :href="route('member.login')"
                    class="ml-4 mr-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400
                        dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >メンバーログイン</Link>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center dark:text-white">Laravel Breeze Mult login test</div>
            ...
            <!-- <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center
